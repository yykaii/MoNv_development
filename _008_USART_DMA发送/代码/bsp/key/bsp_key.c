...
{           
    ...
    {  
        EXTI->PR |= KEY_1_PIN  ;                  
        printf("第 1 个按键被按下, 蓝灯反转\r");         // 魔女开发板的按键使用电容进行硬件消抖,无需再使用软件延时消抖 
        LED_BLUE_TOGGLE;  
    }        
}
...
{           
    ...
    {  
        EXTI->PR |= KEY_2_PIN  ;                  
        printf("第 2 个按键被按下, 蓝灯反转\r");         // 魔女开发板的按键使用电容进行硬件消抖,无需再使用软件延时消抖 
        LED_BLUE_TOGGLE;  
    }        
}
// KEY_3 中断服务函数
...
{           
    ...
    {  
        EXTI->PR |= KEY_3_PIN  ;                  
        printf("第 3 个按键被按下, 蓝灯反转\r");         // 魔女开发板的按键使用电容进行硬件消抖,无需再使用软件延时消抖 
        LED_BLUE_TOGGLE;  
    }        
}
