 ...
 * 分  享： 不断更新于Q群文件夹：   最后修改_2020年09月014日
******************************************************************/
 ...
 * 
 * 备  注： 魔女开发板团队编写   淘宝 https://demoboard.taobao.com
 * 分  享： 不断更新于Q群文件夹：   最后修改_2020年09月01日
******************************************************************/
 ...
 *          uintt32_t fColor  字体颜色
 *          uintt32_t bColor  背景颜色
 * 备  注： 参考原子哥和野火大神的代码后修改  资料存放Q群：  
 *****************************************************************/
 ...
 *          uintt32_t   bColor 背景颜色
 * 返回值:  无
 * 备  注： 魔女开发板   资料更新Q群：     最后修改_2020年05月1８日
 ******************************************************************************/  
...
//    
//    LCD_Printf( 8,  0,"STM32F103RCT6开发板", 24, WHITE, BLACK);    
//    LCD_Printf( 72, 28,"设备检测监控", 16, GREY, BLACK);        
//    LCD_Printf(  6, 52,"板载设备", 16,  BLACK , WHITE);
//    LCD_Printf(125, 52,"WiFi无线通信", 16, BLACK , WHITE);
//    LCD_Printf(125,171,"CAN通信" , 16, BLACK , WHITE);    
//    LCD_Printf(  6,290,"内部温度", 12, BLACK , WHITE);     // 内部温度
//    LCD_Printf(  6,306,"启动次数", 12, BLACK , WHITE);     // 启动次数
//    LCD_Printf(125,290,"触摸坐标", 12, BLACK , WHITE);     // 触摸坐标
//    LCD_Printf(125,306,"运行时长", 12, BLACK , WHITE);     // 运行时长
//    sprintf(strTemp, "第%d次", xW25Qxx .StartupTimes);
//    LCD_Printf( 68,306,strTemp,12,BLUE,WHITE);
//    
//    u16 y=74;
//    // UASRT1
//    LCD_Printf( 6, y, "UART1配置",  12, YELLOW ,BLACK);  
//    if(xUSART.USART1InitFlag ==1)  { LCD_Printf(90,y,"完成", 12, GREEN ,BLACK); }   else    { LCD_Printf(90,y,"失败", 12, RED ,BLACK); }  y=y+15;
//    // SystemClock
//    LCD_Printf( 6, y, "系统时钟",   12, YELLOW ,BLACK);   
//    sprintf(strTemp,"%d",SystemCoreClock/1000000);
//    LCD_Printf(84, y,strTemp,       12, GREEN ,BLACK);  
//    LCD_Printf(96, y, "MHz", 12, GREEN ,BLACK);   y=y+15;
//    // LED指示灯
//    LCD_Printf( 6, y, "LED指示灯",  12, YELLOW ,BLACK);   
//    LCD_Printf(90,y,"完成", 12, GREEN ,BLACK);    y=y+15;
//    // 按键中断
//    LCD_Printf( 6, y, "按键中断",   12, YELLOW ,BLACK);   
//    LCD_Printf(90,y,"完成", 12, GREEN ,BLACK);    y=y+15;
//    // FLASH存储器
//    LCD_Printf( 6, y, "FLASH存储",  12, YELLOW ,BLACK);   
//    if(xW25Qxx.FlagInit  ==1)  { LCD_Printf(71,y,xW25Qxx.type, 12, GREEN ,BLACK); }   else    { LCD_Printf(90,y,"失败", 12, RED ,BLACK); }  y=y+15;
//    // 汉字字库
//    LCD_Printf( 6, y, "汉字字库",   12, YELLOW ,BLACK);  
//    if(xW25Qxx .FlagGBKStorage ==1)  { LCD_Printf(90,y,"正常", 12, GREEN ,BLACK); }   else    { LCD_Printf(90,y,"失败", 12, RED ,BLACK); }  y=y+15;
//    // 显示屏
//    LCD_Printf( 6, y, "显示屏芯片", 12, YELLOW ,BLACK);  
//    sprintf(strTemp,"%X",xLCD.id);        
//    if(xLCD.FlagInit  ==1)  { LCD_Printf(90,y,strTemp, 12, GREEN ,BLACK); }   else    { LCD_Printf(90,y,"失败", 12, RED ,BLACK); }  y=y+15;
//           
}
